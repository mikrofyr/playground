...
def run():
    ...
    while not doExit:
        ...
        if counter_games > 150:
            doExit = True
        while not  (game.crash or doExit):
            ...
            # FIXME: Should be conditional based on existing weight or not
    ...
    print("Saving network state and exiting...")
    agent.model.save('weights.hdf5')
